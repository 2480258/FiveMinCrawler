...
class ExtAttrRequestFactoryTest {
    ...
    fun testGet() {
        ...
        val factory = ExtAttrRequestFactory("a", linkSelector, linkParser)
        ...
        val result = runBlocking {
            ...
            assertEquals(it.requests.first().requestType, RequestType.ATTRIBUTE)
