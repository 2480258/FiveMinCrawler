...
class CrawlerTask3Test {
    
    @Test
    fun testStart_With_Throwing_Policy() {
        val crawlerTask = CrawlerTask3(TaskMockFactory.createThrowingPolicy(), TaskMockFactory.createThrowingPolicy(), TaskMockFactory.createThrowingPolicy())
    ...
    fun testStart_With_Falling_Policy() {
        val crawlerTask = CrawlerTask3(TaskMockFactory.createFallingPolicy(), TaskMockFactory.createFallingPolicy(), TaskMockFactory.createFallingPolicy())
    ...
    fun testStart_With_Succ_Policy() {
        val policySet = TaskMockFactory.createPolicySet3()
        
        val crawlerTask = CrawlerTask3(
